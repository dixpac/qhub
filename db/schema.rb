...
ActiveRecord::Schema.define(version: 2018_04_13_104933) do
  ...
  create_table "likings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["likable_type", "likable_id"], name: "index_likings_on_likable_type_and_likable_id"
  ...
  create_table "oauth2_user_infos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_oauth2_user_infos_on_user_id"
  end
